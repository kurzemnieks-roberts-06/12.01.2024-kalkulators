...
bo = {'size':(16,2), 'font':('Franklin Gothic Book', 24), 'button_color':("black","#ECA527"), 'focus':True}

# izstrādā kalulatora izkārtoumu
layout: list = [
...
window: object = sg.Window('Calculator', layout=layout, element_justification='right', margins=(10,20), background_color="#272533", return_keyboard_events=True)
